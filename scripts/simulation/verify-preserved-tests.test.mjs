...
import { assertions, classifyTracked, issue, normalizeResultBody, normalizedTokens, parseHunks, rustItems, sha256, verifyBChange, verifyClassA, verifyInventoryShape } from "./preserved-tests/core.mjs";
