...
import { classifyTracked, issue, sha256, verifyClassA, verifyInventoryShape } from "./preserved-tests/core.mjs";
...
const changedFiles = git(["diff", "--name-only", baseline, "--", "packages/engine/tests"]).trim().split("\n").filter(Boolean);
