...
import { classifyTracked, issue, sha256, verifyClassA, verifyInventorySchema, verifyInventoryShape } from "./preserved-tests/core.mjs";
...
const diff = git(["diff", "--unified=0", baseline, "--", "packages/engine/tests", "*.rs"]);
...
const { parseHunks } = await import("./preserved-tests/core.mjs");
