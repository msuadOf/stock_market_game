...
test("plan parsers reject bad keys and every pending-event discriminant", () => {
  ...
  assert.throws(() => parsePendingPlanEvents([{ Filled: { plan_id: 1, order_id: 4, qty: "100", child_complete: true, trading_day: 3 } }]), /Filled\.qty/)
