...
export type StrictSaveEnvelope = {
  ...
  readonly strategy_profiles: ReturnType<typeof parseOrderState>["strategy_profiles"]
...
const ROOT_KEYS = ["setup", "seed", "snapshot", "auction_orders", "resting_orders", "price_history", "market_minute_closes", "rng_state", "npc_attention", "strategy_profiles", "retail_experience", "parent_orders", "npc_order_lifecycles", "pending_player", "next_order_id", "civil_clock", "company_operations", "closing_registry", "public_library", "ops_wiring", "disclosures", "plans", "information_states", "belief_books", "watchlists", "price_memories", "pending_plan_events"] as const
