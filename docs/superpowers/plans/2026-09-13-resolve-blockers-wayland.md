...
- [ ] 1. Reconcile prior review/evidence debt and create a clean verification revision
...
- [ ] 2. Make strict Corepack web and clippy gates reproducible
...
- [ ] 3. Make Weston Wayland native Tauri capture and IPC verification pass
...
- [ ] 4. Document named scale/body-limit and platform boundary findings
...
- [ ] 5. Add and execute real WASM/Server/Tauri host-parity matrix
...
- [ ] 6. Make fresh K7 baseline runner resumable and bounded
...
- [ ] 7. Execute and seal all mandated fresh K7 after/sensitivity matrices
...
- [ ] 8. Add and run all-surface release-contract verifier
...
- [ ] 9. Synchronize only verified platform/simulation/release documentation
...
- [ ] 10. Seal final clean-checkout regression and evidence manifest
