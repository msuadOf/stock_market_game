...
impl GameSession {
    ...
    fn project_envelope(
        ...
        // The authoritative legacy runtime still reserves a seller's possible
        // nominal fee shortfall until the Task 8 cutover.  That compatibility
        // reservation belongs to the legacy account budget only: ADR-0017's
        // private escrow ledger always models seller cash as zero.
